...
export const realCases = [
  {
    ...
    "title": {
      "zh": "柠檬饮料 · 六格广告复现",
      "en": "Lemon drink · Six-panel recreation"
    },
    ...
    "image": "/images/case532.jpg",
    "alt": {
      "zh": "图库原图：六格沙滩柠檬饮料微缩广告",
      "en": "Gallery original: a six-panel miniature lemon drink campaign on a beach"
    },
    "focus": {
      "zh": "六格结构、人物一致性、LIMORA 文字与指令遵循",
      "en": "Six-panel structure, character consistency, LIMORA text and prompt adherence"
    },
    "result": {
      "caseId": 532,
      "image": generatedCase532,
      "label": {
        "zh": "GPT 2.5",
        "en": "GPT 2.5"
      },
      "alt": {
        "zh": "本次生成：六格沙滩柠檬广告，底部带 LIMORA 品牌区",
        "en": "New generation: six beach lemon scenes with a LIMORA campaign strip below"
      },
      "summary": {
        "zh": "六格结构与 LIMORA 标识清楚；新增底部品牌区，第二格的悬空柠檬片未严格照做。",
        "en": "The six-panel grid and LIMORA are clear. A campaign strip was added, and panel 2 differs from the requested lemon slice."
      },
      "modelNote": {
      ...
      "parameters": {
        "zh": [
          ...
          {
            "label": "输入",
            "value": "站内案例 #532 完整 Prompt；未改写；无参考图"
          },
          {
            "label": "样本",
            "value": "首次生成 1 张；保留原始结果"
          },
          {
            "label": "原图尺寸",
            "value": "3277 × 4096"
          ...
          {
            "label": "调用等待",
            "value": "约 132 秒（含队列与传输）"
          },
          {
            "label": "模型与质量档位",
            "value": "Codex 内置生图；具体 ID 与档位未返回"
          },
          {
            "label": "费用",
            "value": "工具未返回"
        ...
        "en": [
          ...
          {
            "label": "Input",
            "value": "Full case #532 gallery prompt; unchanged; no reference image"
          },
          {
            "label": "Sample",
            "value": "One first-run image; original output retained"
          },
          {
            "label": "Original size",
            "value": "3277 × 4096"
          ...
          {
            "label": "Call wait",
            "value": "About 132 s, including queueing and transfer"
          },
          {
            "label": "Model and quality",
            "value": "Built-in Codex image tool; exact ID and quality not returned"
          },
          {
            "label": "Cost",
            "value": "Not returned"
          },
          {
            ...
            "value": "Existing gallery case; original model ID, inputs and settings not independently verified"
          }
        ]
      }
    }
